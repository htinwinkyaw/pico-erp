  ...
  return (
    <button
      ...
      className={`
        ...
        px-3 md:px-5 py-2 rounded-md md:rounded-lg text-sm md:text-md font-base outline outline-1 outline-blue-500
      ...
      `}
    >
      {LeftIcon && <LeftIcon size={size ? size : 20} />}
      {labelText}
      {RightIcon && <RightIcon size={size ? size : 20} />}
    </button>
  );
};
